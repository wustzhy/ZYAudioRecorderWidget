...
+ (void) zy_setMeetIDValue:(long)value forButton:(UIButton *)btn{
    ...
    [self zy_setBtn:btn FrontString:@"ID：" frontColor:HexRGB(0xFFFFFF) latterString: [NSString stringWithFormat:@"%ld",value ] position:CGPointMake(GTFixWidthFlaot(10),  GTFixHeightFlaot(61-20)) type:NO];
}
